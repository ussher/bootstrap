	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="{$jamroom_url}">{jrCore_image image="logo.png" width="180" height="45" class="jlogo" alt=$_conf.jrCore_system_name}</a>
			</div>
			<div class="navbar-collapse collapse header-navbar">
				...
				{if jrCore_module_is_active('jrSearch')}
					<li><a data-toggle="modal" href="#searchModal" title="Site Search"><i class="glyphicon glyphicon-search"></i></a>
					</li>
				{/if}
				</ul>
				...
				{if jrUser_is_logged_in()}
					...
					{/if}
					<li class="dropdown">
						<a class="dropdown-toggle" id="userdd" role="button" data-toggle="dropdown" data-target="#" href="{$jamroom_url}/{jrUser_home_profile_key key="profile_url"}">{jrUser_home_profile_key key="profile_name"} <span class="caret"></span></a>
